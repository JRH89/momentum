...
const SignIn = () => {
  ...
  return (
    <div className="flex flex-col gap-4 w-full mx-auto max-w-xs h-full">
      {error && (
        <p className="text-red-500 max-w-sm text-center p-4 bg-white rounded-lg border-2 flex flex-col border-black">
          {error}
        </p>
      )}
