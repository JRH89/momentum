    ...
    <>
      <div className="space-y-4 max-w-xs justify-center h-full my-auto items-center min-h-screen font-semibold flex flex-col mx-auto w-screen px-10">
        ...
        <button
          ...
          type="submit"
          className="bg-confirm hover:bgopacoty-60 shadow-black shadow-md hover:shadow-black hover:shadow-lg duration-300 text-white py-2 px-4 rounded w-full mx-auto"
        >
          Submit
        </button>
