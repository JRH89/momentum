  ...
  return (
    ...
    >
      <div className="flex flex-col mx-auto text-center content-center justify-center items-center text-lg sm:text-2xl gap-5 py-4 w-auto text-gray-800 md:text-3xl my-auto self-center">
        <Link
          href="/About"
          className="py-2 shadow-md shadow-black bg-confirm text-black rounded w-full max-w-xs px-5 text-center hover:bg-confirm/60 transition duration-300 flex items-center gap-2 hover:shadow-black hover:shadow-lg"
        >
        ...
        <Link
          href="/FAQ"
          className="py-2 shadow-md hover:shadow-black hover:shadow-lg shadow-black bg-confirm text-black rounded w-full max-w-xs px-5 text-center hover:bg-confirm/60 transition duration-300 flex items-center gap-2"
        >
