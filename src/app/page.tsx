import {  Info, ArrowBigRightIcon, Text, Book, } from "lucide-react";
      ...
      <Header />
        <main className="bg-gray-900 text-white">
          ...
          >
            ...
            <div className="relative lg:ml-14 z-10 text-left sm:max-w-xl lg:max-w-5xl p-8 pt-28 sm:pt-32 lg:pt-32 lg:w-1/2">
              <div className="flex lg:hidden mb-8">
                <Image
                  width={1920}
                  height={1080}
                  src="/project.png" alt="Project Dashboard" className="w-auto border-2 border-black shadow-md shadow-black h-auto rounded-lg my-auto justify-center items-center z-40" />
              </div>
            <h1 className="text-2xl text-black md:text-5xl font-extrabold mb-2 md:mb-6">
              Project Management for Freelancers & Small Businesses
            </h1>
            <p className="text-lg md:text-xl max-w-3xl lg:text-2xl mb-4 md:mb-8 text-gray-800 font-medium">
              Manage projects, organize customers, and send invoices.
            </p>
            <div className="flex flex-row gap-5 items-center">
              <Link href={"/Signup"} className="bg-confirm hover:shadow-lg border-2 border-black hover:shadow-black transition duration-300 ease-in-out text-black text-xs sm:text-base md:text-xl font-extrabold flex flex-row gap-2 px-4 sm:px-6 py-3 rounded-lg shadow-md shadow-black items-center">
                Get Started <ArrowBigRightIcon className="w-4 h-4 sm:w-6 sm:h-6" />
              </Link>
              <Link href="/#features" className="hover:opacity-60 transition duration-300 ease-in-out items-center font-bold flex flex-row gap-2 text-xs sm:text-base md:text-xl text-black">
          ...
          <div className="relative lg:w-1/2 hidden lg:flex items-center justify-center p-8 pt-28 sm:pt-32 lg:pt-32">
            <Image
              width={1920}
              height={1080}
              src="/project.png" alt="Project Dashboard" className="max-w-lg border-2 border-black shadow-md shadow-black h-auto rounded-lg my-auto justify-center items-center" />
          </div>
        </section>
        <FeaturesSection />
