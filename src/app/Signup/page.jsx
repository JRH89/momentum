  ...
  return (
    <>
      ...
      <div className="flex bg-white justify-center items-center min-h-screen h-full -mt-24 flex-col text-center gap-5 w-full mx-auto">
        <h1 className="text-3xl max-w-2xl mx-auto sm:text-5xl md:text-6xl lg:text-7xl font-semibold text-transparent bg-gradient-to-b from-black via-gray-700 to-confirm bg-clip-text">
